...
namespace PNR_Room_Name
{
    public class Selection
    {
        ...
        public static String functionRoom;
        ...
        private void OnAppoint()
        {
            ...
            using (Transaction tr = new Transaction(_commandData.Application.ActiveUIDocument.Document, "Start"))
            {
                ...
                {
                    if (selectedElement.LookupParameter("PNR_Имя помещения") == null)
                    {
                    ...
                    selectedElement.LookupParameter("PNR_Имя помещения").Set(RoomSelection.RoomName);
                }
                else
                {
        ...
        public void Select()
        {
            ...
            functionRoom = selectedElement.LookupParameter("PNR_Функция помещения").AsString();
        }
